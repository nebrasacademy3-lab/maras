...
The application source in this continuation has passed the final CI runs linked below; later branch commits only update this status note and PR metadata. This checkpoint includes the following implementation work:
