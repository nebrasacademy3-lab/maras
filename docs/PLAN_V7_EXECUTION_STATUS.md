...
The application source validated by CI is `aac6cac596d0b81fbf65de326b8e3182bb7d7`; the latest branch head is `87eb7e99a2fdc12a18a18d991d53b5bb4df54c69` and contains documentation-only follow-up. This checkpoint includes the following implementation work:
