...
**تحديث 20 سبتمبر 2026:** عُثر على المرجع الأصلي `MARAS_ADMIN_REORGANIZATION_PLAN_AR_v7_GEMINI_FREE_FIRST_PAID_FALLBACK.md` في مكتبة المشروع. عبارة غياب المرجع أدناه تصف بحث المستودع بتاريخ إعداد المصفوفة، وليست دليلًا على عدم توفر الخطة. لا تعني استعادة المرجع اجتياز حالاته الـ192. تقدم معالجة المستندات موثق في `STUDY_CHECKPOINT_RECOVERY_2026_09_20_AR.md`؛ بقية الصفوف أدناه سجل تاريخي وليست إعادة اعتماد تلقائي لأحدث نشر.
