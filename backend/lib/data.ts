...
export const faq = [
  { q: "هل أستطيع تجربة الشرح قبل الاشتراك؟", a: "بعض المواد توفر معاينة مجانية عندما يكون درس تجريبي منشورًا وجاهزًا. في جميع الحالات يمكنك مراجعة وصف المادة ووحداتها قبل الاشتراك." },
  ...
  { q: "ماذا أفعل إذا لم أجد مادتي؟", a: "إذا كانت خدمة طلب المواد مفعلة، أرسل طلب توفير باسم المادة ومرفقاتها وسنخبرك عند نشرها. ويمكنك دائمًا التواصل مع الدعم للاستفسار." },
];
...
export const reviews = [
  { name: "قرار أوضح", university: "محتوى منظم", text: "صفحة المادة تعرض الوصف والوحدات والدروس بوضوح، وتظهر المعاينة المجانية فقط عندما تكون مرفوعة وجاهزة.", rating: 5 },
