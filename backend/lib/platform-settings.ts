...
export const SETTING_META: Record<PublicSettingKey, { label: string; category: string }> = {
  ...
  footer_description: { label: "وصف الفوتر", category: "general" },
  app_download_title: { label: "عنوان تنزيل التطبيق", category: "apps" },
  app_download_description: { label: "وصف تنزيل التطبيق", category: "apps" },
  ios_app_url: { label: "رابط تطبيق iPhone / App Store", category: "apps" },
  android_app_url: { label: "رابط تطبيق Android / Google Play", category: "apps" },
