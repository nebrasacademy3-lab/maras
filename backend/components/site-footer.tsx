    ...
    <footer className="site-footer">
      <div className="container footer-grid">
        <div className="footer-brand">
          <BrandLogo markOnly />
          <p>منصة سعودية تجمع شروحات المواد الجامعية في مكان واحد، بتجربة عربية مرتبة ومترابطة على الويب والتطبيق.</p>
        ...
        <div><h3>استكشف</h3><Link href="/universities">الجامعات والكليات</Link><Link href="/courses">جميع المواد</Link>{requestsEnabled&&<Link href="/request-course">اطلب مادة</Link>}<Link href="/how-it-works">كيف تعمل مراس؟</Link></div>
