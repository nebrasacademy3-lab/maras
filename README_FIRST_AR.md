> **أحدث تسليم:** اقرأ أولًا `LATEST_RELEASE_AR.md` و`RELEASE_FILE_SCAN_FIX_20260911_AR.md`، ثم `FILE_SCANNING_AR.md`. التعليمات والتقارير القديمة أدناه محفوظة للسياق.

# مراس العلم — نسخة موحدة للنشر والبناء

> **تحديث 11 سبتمبر 2026:** ابدأ من [تقرير التسليم الحالي](RELEASE_20260911_AR.md) و[دليل الإدارة](docs/ADMIN_CONTROL_GUIDE_AR.md). أضيف الترحيل `0029` ويجب تطبيق سلسلة الترحيلات بالترتيب. هذه نسخة مصدر معدّلة؛ **البناء الإنتاجي والترحيل الحي لم يُتحقق منهما في بيئة التسليم**. نتائج الاختبارات الفعلية في `verification/20260911/`. ملف سلامة المصدر الحالي `SOURCE_CHECKSUMS_20260911.sha256`. التقارير والنتائج الأقدم تاريخية وليست اعتمادًا لهذه النسخة.

التعليمات الأصلية أدناه محفوظة كمرجع؛ عند اختلاف حالة التحقق أو خطوات الترقية، اتبع تقرير 11 سبتمبر أعلاه.
