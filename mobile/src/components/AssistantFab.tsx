...
const styles = StyleSheet.create({ layer: { position: "absolute", left: 18, bottom: 96, zIndex: 50 }, button: { width: 62, height: 62, borderRadius: 22, borderWidth: 1, alignItems: "center", justifyContent: "center", shadowColor: "#000", shadowOpacity: .18, shadowRadius: 16, shadowOffset: { width: 0, height: 8 }, elevation: 8 }, mark: { width: 51, height: 34 } });
