...
const styles = StyleSheet.create({
  header: { minHeight: 62, flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 14 }, authHeader: { minHeight: 62, flexDirection: "row", alignItems: "center", gap: 10, marginBottom: 14 }, authCopy: { flex: 1, alignItems: "flex-start" }, authTitle: { fontSize: 16, fontWeight: "900", writingDirection: "rtl" }, authActions: { flexDirection: "row", gap: 7 }, copy: { flex: 1, alignItems: "flex-start" }, commerceActions: { flexDirection: "row", gap: 6 }, title: { fontSize: 18, fontWeight: "900", writingDirection: "rtl" }, subtitle: { fontSize: 10, marginTop: 2, writingDirection: "rtl" }, iconButton: { width: 42, height: 42, borderRadius: 15, borderWidth: 1, alignItems: "center", justifyContent: "center" }, badge: { position: "absolute", top: -4, left: -4, minWidth: 18, height: 18, paddingHorizontal: 3, borderRadius: 9, alignItems: "center", justifyContent: "center", borderWidth: 2, borderColor: "white" }, badgeText: { color: "#FFF", fontSize: 8, fontWeight: "900" },
});
