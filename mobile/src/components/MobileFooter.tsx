...
export function MobileFooter() {
  ...
  return <View style={[styles.footer, { borderTopColor: colors.border }]}>
    <Image source={require("../../assets/brand-mark.png")} style={styles.mark} resizeMode="contain" accessibilityLabel="مراس العلم" />
...
const styles = StyleSheet.create({
  ...
  stores: { width: "100%", flexDirection: "row-reverse", gap: 7, marginTop: 10 },
  store: { flex: 1, minHeight: 50, paddingHorizontal: 11, borderRadius: 15, backgroundColor: "#071127", flexDirection: "row-reverse", alignItems: "center", justifyContent: "center", gap: 8 },
