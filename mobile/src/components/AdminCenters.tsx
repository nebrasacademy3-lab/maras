...
type StudentProfile = {
  ...
  student: { updatedAt: string; id: number; email: string; phone: string | null; fullName: string; status: string; universitySlug: string | null; specialty: string | null; academicLevel: string | null; lastLoginAt: string | null; createdAt: string };
