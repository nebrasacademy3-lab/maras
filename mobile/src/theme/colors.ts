...
const commonLight = { background: "#F5F7FB", surface: "#FFFFFF", surfaceAlt: "#F0F4FB", text: "#071B45", textSoft: "#5C6A80", border: "#DFE5EF", success: "#0B9B69", warning: "#D7820D", danger: "#D9384E", tab: "#FFFFFF", overlay: "rgba(7,27,69,.55)", shadow: "#061A42", onPrimary: "#FFFFFF", action: "#214DCA", hero: "#111E40", heroEnd: "#183B79" };
const commonDark = { background: "#050B18", surface: "#0B162B", surfaceAlt: "#101F3A", text: "#F7FAFF", textSoft: "#9EADC5", border: "#1B2D4A", success: "#33D49A", warning: "#FFB84D", danger: "#FF6C7E", tab: "#081326", overlay: "rgba(0,0,0,.72)", shadow: "#000000", onPrimary: "#FFFFFF", action: "#214DCA", hero: "#111E40", heroEnd: "#183B79" };
...
export function colorsFor(palette: PaletteId, dark: boolean): AppColors { return { ...(dark ? commonDark : commonLight), ...(dark ? paletteTones[palette].dark : paletteTones[palette].light), action: ({ official: "#214DCA", violet: "#6440CE", rose: "#B92961", teal: "#05727A" })[palette] }; }
