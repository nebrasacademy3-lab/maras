...
const styles = StyleSheet.create({
  ...
  topbar: { width: "100%", flexDirection: "row-reverse", alignItems: "center", justifyContent: "space-between", marginBottom: 14 },
  ...
  progressHeader: { width: "100%", flexDirection: "row-reverse", alignItems: "flex-end", justifyContent: "space-between" },
  ...
  progressRow: { width: "100%", flexDirection: "row-reverse", gap: 5, marginTop: 14, marginBottom: 16 },
  ...
  heroOrbOne: { width: 260, height: 260, borderRadius: 130, position: "absolute", top: -135, right: -78, backgroundColor: "rgba(255,255,255,.10)" },
  heroOrbTwo: { width: 150, height: 150, borderRadius: 75, position: "absolute", bottom: -78, left: -32, borderWidth: 1, borderColor: "rgba(255,255,255,.14)" },
  ...
  heroNumber: { position: "absolute", top: 15, left: 18, color: "rgba(255,255,255,.32)", fontSize: 42, fontWeight: "900" },
  ...
  point: { flexDirection: "row-reverse", alignItems: "center", gap: 8 },
  ...
  back: { minHeight: 38, flexDirection: "row-reverse", alignItems: "center", justifyContent: "center", gap: 6 },
