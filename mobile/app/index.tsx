...
export default function Index() {
  ...
  return <Screen scroll={false} style={{ alignItems: "center", justifyContent: "center" }}><BrandMark size={112} whiteTile /><LoadingState label="نجهّز تجربتك التعليمية..." /></Screen>;
}
