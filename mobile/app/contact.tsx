...
const styles = StyleSheet.create({ hero: { borderRadius: 22, padding: 22, marginBottom: 18 }, heroTitle: { color: "#FFF", fontSize: 23, fontWeight: "900", textAlign: "right", marginTop: 10 }, heroCopy: { color: "rgba(255,255,255,.84)", fontSize: 11, lineHeight: 20, textAlign: "right", marginTop: 5 }, channelGrid: { flexDirection: "row", justifyContent: "space-between" }, channel: { alignItems: "center", minHeight: 125 }, channelTitle: { fontSize: 13, fontWeight: "900", marginTop: 8 }, channelCopy: { fontSize: 9, marginTop: 3, textAlign: "center" }, socialGrid: { flexDirection: "row", flexWrap: "wrap", gap: 8 }, social: { width: "48%", minHeight: 52, borderWidth: 1, borderRadius: 15, paddingHorizontal: 11, flexDirection: "row", alignItems: "center", gap: 7 }, socialText: { flex: 1, fontSize: 10, fontWeight: "800", textAlign: "right" }, supportCard: { marginTop: 20, alignItems: "flex-start" }, supportTitle: { fontSize: 16, fontWeight: "900", marginTop: 8 }, supportCopy: { fontSize: 10, lineHeight: 19, textAlign: "right", marginVertical: 8 }, empty: { textAlign: "center", fontSize: 11, lineHeight: 20, padding: 12 } });
