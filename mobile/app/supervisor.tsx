...
const styles = StyleSheet.create({ flex: { flex: 1 }, tabs: { flexDirection: "row", gap: 9 }, tab: { flex: 1, minHeight: 65, borderWidth: 1, borderRadius: 18, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8 }, feedback: { fontSize: 10, fontWeight: "800", textAlign: "center", marginTop: 12 }, request: { marginBottom: 10 }, requestHead: { flexDirection: "row", alignItems: "center", gap: 10 }, counter: { minWidth: 48, minHeight: 40, borderRadius: 13, alignItems: "center", justifyContent: "center" }, title: { fontSize: 14, fontWeight: "900", textAlign: "right" }, meta: { fontSize: 8, marginTop: 4, textAlign: "right" }, notes: { fontSize: 10, lineHeight: 18, textAlign: "right", marginVertical: 10 }, file: { minHeight: 42, borderTopWidth: 1, flexDirection: "row", alignItems: "center", gap: 8 }, fileName: { flex: 1, fontSize: 9, textAlign: "right" }, fileSize: { fontSize: 7 }, statuses: { flexDirection: "row", gap: 6, paddingVertical: 9 }, status: { minHeight: 35, paddingHorizontal: 11, borderRadius: 11, alignItems: "center", justifyContent: "center" }, courses: { flexDirection: "row", gap: 8, paddingBottom: 12 }, courseChip: { minHeight: 44, borderWidth: 1, borderRadius: 14, paddingHorizontal: 14, alignItems: "center", justifyContent: "center" }, fieldLabel: { fontSize: 12, fontWeight: "800", textAlign: "right", marginBottom: 5 }, unitCard: { marginBottom: 10, paddingVertical: 7 }, unitTitle: { fontSize: 14, fontWeight: "900", textAlign: "right", padding: 9 }, lesson: { minHeight: 75, borderTopWidth: 1, flexDirection: "row", alignItems: "center", gap: 9, paddingVertical: 10 }, lessonTitle: { fontSize: 10, fontWeight: "900", textAlign: "right" }, videoState: { width: 42, height: 42, borderRadius: 13, alignItems: "center", justifyContent: "center" } });
