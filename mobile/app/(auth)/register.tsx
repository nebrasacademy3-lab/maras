...
export default function Register() {
  ...
  const [form, setForm] = useState({ fullName: "", email: "", phone: "", password: "", universitySlug: "", specialty: "" });
