...
const styles = StyleSheet.create({
  ...
  emptyActionText: { color: "#FFF", fontSize: 10, fontWeight: "900" }, emptyButtons:{width:"100%",gap:8,marginTop:4}, emptyReset:{minHeight:42,borderWidth:1,borderRadius:13,alignItems:"center",justifyContent:"center"}, emptyResetText:{fontSize:10,fontWeight:"900"},
});
