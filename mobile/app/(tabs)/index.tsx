...
export default function Home() {
  ...
  return <Screen>
    ...
    <FadeIn>
      <LinearGradient colors={[colors.primaryDark, colors.primary, colors.violet]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={[styles.hero, wide && styles.heroWide, { direction }]}>
        ...
        <View style={[styles.heroLayout, wide && { flexDirection: rowDirection }]}>
          <View style={styles.heroCopyColumn}>
            ...
            <Text style={[styles.heroTitle, wide && styles.heroTitleWide, { color: colors.onPrimary }]}>{first ? "خطوة جديدة،\nوفهم أعمق." : "لكل طموح بداية.\nابدأها بفهم."}</Text>
          ...
          {first ? <View style={[styles.studyCard, wide && styles.studyCardWide, { backgroundColor: colors.surface, borderColor: colors.border, shadowColor: colors.shadow }]}>
            ...
            <Text numberOfLines={2} style={[styles.studyTitle, { color: colors.text }]}>{first.title}</Text>
...
const styles = StyleSheet.create({
  ...
  heroTitle: { fontSize: 35, lineHeight: 49, fontWeight: "900", letterSpacing: -.7 }, heroTitleWide: { fontSize: 46, lineHeight: 62 }, heroCopy: { fontSize: 13, lineHeight: 25, marginTop: 16, maxWidth: 490, opacity: .9 }, heroActions: { gap: 10, marginTop: 27 },
