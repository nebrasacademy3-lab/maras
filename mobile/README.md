...
- طلب مادة مع رفع حتى 100 ملف بإجمالي 100MB، متابعة الحالات، إشعارات داخلية وPush، وتذاكر دعم وردود وواتساب وروابط التواصل.
...
- مزامنة تلقائية في مقدمة التطبيق كل خمس ثوانٍ تُبطل فقط استعلامات القنوات المتغيرة؛ تغييرات الإدارة والمشرف والدعم تظهر دون إعادة فتح الشاشة.
- المواد المنشورة تبقى قابلة للاشتراك حتى لو كانت بعض الفيديوهات ستُضاف لاحقًا، ويظهر المحتوى المتوفر مباشرة دون وصف المادة بأنها غير مكتملة.
...
تم اجتياز TypeScript وESLint وExpo Doctor ‏21/21 وتجميع Metro للويب وAndroid وiOS في 27 أغسطس 2026.
...
لا ترفع `.env` أو أي مفاتيح خاصة إلى Git. مفاتيح Tap ومزود المساعد وتوقيع الفيديو تبقى في الخادم فقط ولا تدخل حزمة التطبيق.
