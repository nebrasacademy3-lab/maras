...
export default ({ config }: ConfigContext): ExpoConfig => {
  ...
  return {
    ...
    android: {
      ...
      allowBackup: false,
      blockedPermissions: ["android.permission.READ_MEDIA_IMAGES", "android.permission.READ_MEDIA_VIDEO", "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE"],
      permissions: [
        "POST_NOTIFICATIONS",
        "RECORD_AUDIO",
      ],
