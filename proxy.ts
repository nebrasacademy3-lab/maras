...
const mobilePaths = ["/api/mobile/", "/api/public/", "/api/catalog/", "/api/assistant", "/api/support", "/api/course-requests", "/api/course-resources", "/api/favorites", "/api/cart", "/api/waitlist", "/api/profile", "/api/progress", "/api/reviews", "/api/video/", "/api/invoices/", "/api/admin/", "/api/supervisor/", "/api/ai/", "/api/auth/", "/api/checkout", "/api/coupons/", "/api/referrals", "/api/sync", "/api/learning-tracks/", "/api/analytics"];
