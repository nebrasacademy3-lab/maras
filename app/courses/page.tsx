...
export async function generateMetadata({ searchParams }: { searchParams: Promise<SeoSearchParams> }): Promise<Metadata> {
  return resolvedPublicPageMetadata("/courses", "شروحات المواد الجامعية", "تصفح المواد الجامعية في مراس العلم حسب الجامعة والتخصص، واستعرض خطة الدروس والأسعار والمعاينات المجانية المتاحة قبل الاشتراك.", { noindex: catalogHasFilters(await searchParams) });
}
