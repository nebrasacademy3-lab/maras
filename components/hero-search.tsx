      ...
      {query && (
        <div className="hero-search-results">
          {results.length ? results.map((result) => (
            ...
            <Link href="/request-course"><i><TrendingUp size={17} /></i><span><strong>لم تجد ما تبحث عنه؟</strong><small>اطلب توفير المادة · نستهدف التوفير خلال 24 ساعة</small></span><ArrowLeft size={16} /></Link>
          )}
        </div>
      )}
