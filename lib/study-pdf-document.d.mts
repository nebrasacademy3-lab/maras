export type StudyPdfInput = { title: string; content: string; sourceName: string; createdAt: string; branding: { siteUrl: string; whatsapp: string; description: string; links: Array<{ label: string; url: string }> } };
