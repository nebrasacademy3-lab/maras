...
export const complianceCatalog: ComplianceItem[] = [
  ...
  { key: "ai_governance", area: "الأدوات الرقمية", title: "حوكمة أدوات المذاكرة", description: "بيان الاستخدامات المسموحة وحدود المخرجات والمراجعة البشرية والخصوصية.", evidenceHint: "سياسة الأدوات، سجل تغييرات، اختبارات جودة" },
