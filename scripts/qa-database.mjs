...
const pg = new EmbeddedPostgres({ databaseDir:directory,createPostgresUser:process.getuid?.()===0,user:"maras_qa",password,port:55439,persistent:false,authMethod:"scram-sha-256",initdbFlags:["--encoding=UTF8","--locale=C"],postgresFlags:["-c","listen_addresses=127.0.0.1"],onLog:()=>{},onError:()=>{} });
