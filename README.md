...
راجع [تسليم 9 سبتمبر — التعديلات والتحقق والتشغيل](RELEASE_20260909_AR.md) أولًا. يجب تطبيق الترحيل `0028` قبل تشغيل المصادقة الجديدة لتفعيل الجهازين المعتمدين. ملف سلامة المصدر الحالي هو `SOURCE_CHECKSUMS_20260909.sha256`.
